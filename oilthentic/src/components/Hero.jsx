...
import  { bgMobile1, buttonDaftar, bgWeb1, mobileTitle } from '../assets/index'
...
const Hero = (props) => {
  ...
  // }, [props])
  return (
    <div className="w-screen antialiased relative merry-font h-screen overflow-hidden broken-white-1 -top-1">
