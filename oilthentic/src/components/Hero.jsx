    ...
    // <div className="merry-font h-full w-full bg-red-200 flex justify-center">
      <div className="bgImage" id="herobanner"
        ...
        <img src={props.page === 'thankyou' ? mobileTitleThankYou : mobileTitle} alt="Road to Oilthentic Day 2021" className="landingtitle -mt-40 mb-10 w-3/4 lg:w-5/12 xl:w-1/3 xl:mt-5 xl:-mt-5"
          ...
          { props.page !== 'thankyou' && (
            <>
              <h2 className="purple-text leading-tight font-bold text-center text-base md:text-2xl xl:text-3xl md:px-20">Jadilah Bagian Dari Gerakan Ini Dan Dapatkan Promo Lebih Banyak!</h2>
              <h3 className="mt-3 text-gray-900 text-center text-sm font-semibold text-base md:text-2xl xl:text-3xl">{totalShareAll.toLocaleString()} Orang sudah menjadi bagian</h3>
