    ...
    style={{ backgroundColor: '#E8E3DD' }}>
      <div className="min-w-screen h-full bg-center bg-cover flex justify-center "
        style={{ backgroundImage: props.isMobile ? `url(${bgMobile5})` : `url(${webMilestone4})`, backgroundSize: 'cover' }} >
          <div className="px-5 flex flex-col justify-end py-20 md:items-start w-screen min-h-screen">
            {/* Bubble */}
            <div className="flex flex-col gap-48">
              <div className=" px-2 md:w-1/2 self-end mt-32">
                <img src={bubble3BW} alt="300.000 shares" className="w-32 md:w-48 self-end"/>
              </div>
              <div className=" px-2 md:w-1/2 px-2 self-start">
