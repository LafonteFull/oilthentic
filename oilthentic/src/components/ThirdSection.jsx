...
const ThirdSection = (props) => {
  return (
    <div className="merry-font bgrepeat w-screen"
    style={{ backgroundColor: '#E8E3DC', backgroundImage: `url(${bgr10})` }}>
      <div className="px-5 flex flex-col justify-center items-center w-full md:py-20 py-10">
            <div className="flex flex-col items-center px-2 md:mt-5 w-full">
              ...
              <p className="poppins-font purple-text text-justify text-xs mt-3 md:text-3xl md:mt-20 md:px-10"> Hadiah didapatkan untuk setiap pembelian PEP Young Living Indonesia di tanggal 25 dan 26 April 2021 berdasarkan total jumlah share yang dihasilkan.</p>
              <div className="flex flex-row justify-center items-center md:px-10 py-2 mt-2 w-full ">
                <img src={bothproducts} alt="Products" style={{ minWidth: '40vw' }} 
