    ...
    style={{ backgroundColor: '#E8E3DC', backgroundImage: `url(${bgr10})` }}>
      <div className="px-5 flex flex-col justify-center items-center w-full md:py-20 py-10">
            <div className="flex flex-col items-center px-2 md:mt-5 w-full">
              ...
              <p className="poppins-font purple-text text-justify text-xs mt-3 md:text-2xl md:mt-20 md:px-10 lg:px-20"> Hadiah didapatkan untuk setiap pembelian PEP Young Living Indonesia di tanggal 25 dan 26 April 2021 berdasarkan total jumlah share yang dihasilkan.</p>
