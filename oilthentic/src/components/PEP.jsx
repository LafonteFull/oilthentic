...
const PEP = (props) => {
  return (
    ...
    style={{  backgroundColor: '#E8E3DD' , backgroundImage: props.isMobile ? `url(${bgMobile8})` : `url(${bgWeb5})` }}>
      <div className="flex text-white flex-col min-w-screen items-center py-10 px-5">
          <div className="px-10 flex flex-col justify-center items-center content-center">
            <h3 className="purple-text merry-font text-center font-bold h-full text-base md:text-3xl px-10">Kenapa Kamu Harus Beli PEP Young Living</h3>
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center px-10 mt-2 py-10">
