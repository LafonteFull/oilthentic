...
const SecondSection = () => {
  return (
    <div className="w-screen relative merry-font h-screen overflow-hidden broken-white-1 -top-20 z-2">
      <div className="min-w-screen relative top-0 h-full bg-center bg-cover flex py-5"
        style={{ backgroundImage: `url(${bgMobile2})`, backgroundSize: 'cover' }} >
          <div className="px-5 flex flex-col justify-center items-center content-center w-screen">
            <p className="poppins-font px-2 purple-text text-justify text-xs mt-20">Dengan cara share acara ini di social media Anda, maka Anda sudah berkontribusi untuk mendapatkan promo lebih banyak pada saat Oilthentic Day 2021. Ajak teman Anda untuk ikut gerakan ini untuk mendapatkan semua promo yang tersedia!</p>
            ...
            <div className="flex flex-col items-center px-2 mt-5">
              ...
              <p className="poppins-font purple-text text-center text-xs mt-3"> Hadiah didapatkan untuk setiap pembelian PEP Young Living Indonesia di tanggal 25 dan 26 April 2021 berdasarkan total jumlah share yang dihasilkan.</p>
              <div className="flex flex-row justify-center items-center px-10 py-2">
                <img src={product2} alt="Product 1" className="ml-10" style={{width: '10em'}}/>
                <img src={product3} alt="Product 2" className="m-3" style={{width: '14em'}}/>
              </div>
            </div>
        </div>
      </div>
